...
const INSIGHTS = [
  ...
  },
  {
    ...
    content: `
      <p>On March 17, 2026, the Securities and Exchange Commission and Commodity Futures Trading Commission issued a joint interpretation addressing how federal securities laws apply to certain crypto assets and related transactions (the Joint Interpretation).<sup>[1]</sup> This guidance reflects the SECs view that most crypto assets are not themselves securities. The CFTC further states that it will administer the Commodity Exchange Act consistently with the interpretation and recognizes that certain non-security crypto assets may constitute commodities subject to its oversight.</p>
