...
const ARTICLES = {
  ...
  'sec-cftc-joint-interpretation-crypto': {
    ...
    description: "The SEC and CFTC's March 17, 2026 joint interpretation clarifies how federal securities laws apply to crypto assets, reaffirming Howey while introducing a functional taxonomy and guidance on staking, mining, and token separation.",
  },
...
export default async function middleware(request) {
  ...
  if (id && ARTICLES[id]) {
    pageTitle = ARTICLES[id].title + ' — Michael Gertsik';
